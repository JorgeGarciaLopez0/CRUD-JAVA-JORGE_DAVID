...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    public frmEmpleados() {
        ...
        String[] titulos= {"ID","Nombre","Correo","Telefono","Ciudad"};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert= String.format("INSERT INTO Empleados (ID, Nombre, Correo)"
                + "VALUES (null, '%s','%s')", oEmpleados.getNombre(), oEmpleados.getCorreo(),oEmpleados.getCiudad(),oEmpleados.getTelefono());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit= String.format("UPDATE Empleados SET Nombre='%s',"
                + "Correo='%s' WHERE ID = %d", oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getID(),oEmpleados.getCiudad(),oEmpleados.getTelefono());
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Object[] oUsuario={resultado.getString("ID"),resultado.getString("Nombre"),resultado.getString("Correo"), resultado.getString("Ciudad"),resultado.getString("Telefono")};
    ...
    public empleadosBL recuperarDatosGUI(){
        ...
        oEmpleados.setCorreo(txtCiudad.getText());
        oEmpleados.setCorreo(txtTelefono.getText());
        return oEmpleados;
    }
    /*funcion limpiar*/
    public void limpiar(){
